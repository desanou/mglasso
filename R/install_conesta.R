...
#' @export
#'
install_pylearn_parsimony <- function(conda = "auto",
  ...
  reticulate::py_install(packages = c(extra_pack, 'pylearn-parsimony'),
                         envname = envname,
                         python_version = conda_py_version,
                         pip = TRUE,
                         pip_options = '-f https://github.com/neurospin/pylearn-parsimony/releases')
